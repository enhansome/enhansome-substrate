...
* [Polkadot Stack](https://github.com/w3f/Grants-Program/blob/master/docs/polkadot_stack.md) ⭐ 1,189 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-19 - An `awesome list` maintained by our friends at [Web3 Foundation](https://web3.foundation/).
...
* [Frontier](https://github.com/paritytech/frontier/tree/master/template) ⭐ 615 | 🐛 153 | 🌐 Rust | 📅 2026-09-02 - Fronter enabled EVM and Ethereum RPC compatible Substrate node, ready for hacking.
...
* [Bridges](https://github.com/paritytech/parity-bridges-common) ⭐ 280 | 🐛 80 | 🌐 Rust | 📅 2026-09-16 - A collection of tools for cross-chain communication.
...
* [Polkadot-JS API](https://github.com/polkadot-js/api/) ⭐ 1,111 | 🐛 44 | 🌐 TypeScript | 📅 2026-07-22 - Semi-official JavaScript library for Substrate-based chains.
* [`subxt`](https://github.com/paritytech/substrate-subxt) ⭐ 489 | 🐛 92 | 🌐 Rust | 📅 2026-09-18 - Official Rust client.
...
* [Polkadot-JS Extension](https://github.com/polkadot-js/extension) ⭐ 1,020 | 🐛 52 | 🌐 TypeScript | 📅 2026-07-31 - Browser extension for interacting with Substrate-based chains.
...
* [Nova Polkadot Utils](https://github.com/nova-wallet/nova-utils) ⭐ 44 | 🐛 45 | 🌐 Python | 📅 2026-09-16 - Contains static info & metadata to support client apps in Polkadot ecosystem to map it to various netowrks.
...
* [SubQuery](https://subquery.network) - A GraphQL indexer and query service that allows users to easily create indexed data sources and host them online for free.
  * [Nova SubQuery API](https://github.com/nova-wallet/subquery-nova) ⭐ 22 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-15 - A SubQuery API implementation for operation history and staking analytics.
...
* JavaScript / TypeScript implementations:
  * [polkadot-js/api](https://github.com/polkadot-js/api/tree/master/packages/types) ⭐ 1,111 | 🐛 44 | 🌐 TypeScript | 📅 2026-07-22 - Maintained by Polkadot-JS.
