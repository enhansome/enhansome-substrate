...
> Please see [`awesome-dot`](https://github.com/haquefardeen/awesome-dot) ⭐ 124 | 🐛 6 | 📅 2025-11-24 for a similar list that is more general to the entire Polkadot ecosystem, not just Substrate.
...
[GitHub](https://github.com/paritytech/substrate) ⚠️ Archived.
...
* [Polkadot Stack](https://github.com/w3f/Grants-Program/blob/master/docs/polkadot_stack.md) ⭐ 1,187 | 🐛 3 | 🌐 JavaScript | 📅 2026-03-19 - An `awesome list` maintained by our friends at [Web3 Foundation](https://web3.foundation/).
...
* Technical Papers
  * [Polkadot: Vision for a heterogeneous multi-chain framework](https://github.com/polkadot-io/polkadotpaper/raw/master/PolkaDotPaper.pdf) ⭐ 191 | 🐛 5 | 🌐 TeX | 📅 2020-05-13
  * [Polkadot Lightpaper](https://polkadot.network/Polkadot-lightpaper.pdf)
  * [Overview of Polkadot and its Design Considerations](https://arxiv.org/abs/2005.13456.pdf)
    * [Chinese Translation](https://github.com/AmadeusGB/Overview-of-Polkadot) ⭐ 31 | 🐛 0 | 📅 2021-09-01 (by community)
...
* [Frontier](https://github.com/paritytech/frontier/tree/master/template) ⭐ 614 | 🐛 148 | 🌐 Rust | 📅 2026-08-10 - Fronter enabled EVM and Ethereum RPC compatible Substrate node, ready for hacking.
...
* [Base](https://github.com/substrate-developer-hub/substrate-node-template) - Minimal FRAME-based
  node, derived from [upstream](https://github.com/paritytech/substrate/tree/master/bin/node-template) ⚠️ Archived.
* [Parachain](https://github.com/substrate-developer-hub/substrate-parachain-template) - Cumulus enabled Substrate node, derived from [upstream](https://github.com/paritytech/cumulus/tree/master/parachain-template) ⚠️ Archived.
...
* [Official in Substrate](https://github.com/paritytech/substrate/tree/master/frame) ⚠️ Archived - Large collection, Parity maintained.
* [Open Runtime Module Library (ORML)](https://github.com/open-web3-stack/open-runtime-module-library) ⭐ 466 | 🐛 59 | 🌐 Rust | 📅 2026-03-17 - Community maintained collection of Substrate runtime modules.
* [Chainlink Feed Pallet](https://github.com/smartcontractkit/chainlink-polkadot) ⚠️ Archived - Chainlink feed token interface.
* [RMRK Pallets](https://github.com/rmrk-team/rmrk-substrate) ⭐ 72 | 🐛 20 | 🌐 TypeScript | 📅 2023-10-06 - Nested, conditional & Multi-resourced NFTs.
* [Sunshine Identity](https://github.com/sunshine-protocol/sunshine-keybase/tree/master/identity/pallet) ⚠️ Archived - Keybase-inspired identity management.
* [Sunshine Faucet](https://github.com/sunshine-protocol/sunshine-keybase/tree/master/faucet/pallet) ⚠️ Archived - Dispense resources for a development chain.
...
* [Frontier](https://github.com/paritytech/frontier) ⭐ 614 | 🐛 148 | 🌐 Rust | 📅 2026-08-10 - End-to-end Ethereum emulation for Substrate chains.
...
* [`subxt`](https://github.com/paritytech/substrate-subxt) ⭐ 488 | 🐛 89 | 🌐 Rust | 📅 2026-08-10 - Official Rust client.
* [Rust API Client](https://github.com/scs/substrate-api-client) ⭐ 263 | 🐛 49 | 🌐 Rust | 📅 2026-07-17 - Rust client maintained by [Supercomputers Systems AG](https://www.scs.ch/).
...
* [Sub-Api](https://github.com/kodadot/packages/tree/main/sub-api) ⭐ 4 | 🐛 59 | 🌐 TypeScript | 📅 2025-12-23 - Friendly wrapper for Polkadot.js API maintained by KodaDot.
* [.NET Toolchain/SDK](https://github.com/ajuna-network/Ajuna.SDK) ⭐ 2 | 🐛 0 | 📅 2023-03-26 - Toolchain for Substrate .NET. Pre-generated [SubstrateNET](https://github.com/ajuna-network/SubstrateNET) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2022-11-21; Maintained by Ajuna Network.
...
* [Nova Polkadot Utils](https://github.com/nova-wallet/nova-utils) ⭐ 45 | 🐛 40 | 🌐 Python | 📅 2026-08-13 - Contains static info & metadata to support client apps in Polkadot ecosystem to map it to various netowrks.
...
* [`substrate-js-utils`](https://github.com/shawntabrizi/substrate-js-utilities) ⭐ 31 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-26 - A set of useful JavaScript utilities for Substrate that uses the Polkadot{JS} API; Also [deployed as a website](https://www.shawntabrizi.com/substrate-js-utilities/).
* [`polkadot-scripts`](https://github.com/paritytech/polkadot-scripts) ⭐ 27 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-21 - A collection of scripts Parity uses to diagnose Polkadot/Kusama.
* [`subsee`](https://github.com/ascjones/subsee) ⚠️ Archived - CLI to inspect metadata of a Substrate node as JSON.
* [`polkadot-starship`](https://github.com/koute/polkadot-starship) ⭐ 23 | 🐛 0 | 🌐 Ruby | 📅 2024-03-06 - Another tool to launch a local Polkadot test network, with emphasis on the ability to run big testnets.
* [`srtool-cli`](https://github.com/chevdor/srtool-cli) ⭐ 23 | 🐛 11 | 🌐 Rust | 📅 2025-02-27 - CLI frontend for the `srtool` Docker image.
* [fudge](https://github.com/centrifuge/fudge) ⭐ 22 | 🐛 14 | 🌐 Rust | 📅 2024-06-06 - Core lib for accessing and (arbitrarily) manipulating substrate databases, including the building and importing of local blocks.
* [`srtool-actions`](https://github.com/chevdor/srtool-actions) ⭐ 20 | 🐛 5 | 🌐 Just | 📅 2024-01-02 - GitHub actions to easily use the `srtool` Docker image to build your own runtime.
* [Substrate Docker Builders](https://github.com/ETeissonniere/substrate-nodeops) ⭐ 20 | 🐛 2 | 🌐 Dockerfile | 📅 2023-04-13 - A set of Dockerfiles and GitHub Actions to auto-build and push a Docker image for Substrate-based chains.
* [`scale-value`](https://github.com/paritytech/scale-value) ⭐ 18 | 🐛 2 | 🌐 Rust | 📅 2026-02-17 - Analogous to `serde_json` but for SCALE; Library to decode arbitrary SCALE encoded bytes into a dynamic `Value` given type info from `scale-info`.
* [Proxy Hot Wallet Demo](https://github.com/emostov/proxy-hot-wallet) ⭐ 18 | 🐛 2 | 🌐 TypeScript | 📅 2021-04-30 - A demonstration of a secure, convenient, and flexible hot wallet architecture built on Substrate primitives.
* [`sup`](https://github.com/clearloop/sup) ⭐ 17 | 🐛 1 | 🌐 Rust | 📅 2021-12-07 - Command line tool for generating or upgrading a Substrate node.
* [Typechain-Polkadot](https://github.com/Supercolony-net/typechain-polkadot) ⭐ 14 | 🐛 3 | 🌐 TypeScript | 📅 2023-06-06 - Hepls users to generate typescript types from contract ABIs (ink!) and generate runtime code to interact with contracts and deploy them.
* [Gantree Library](https://github.com/gantree-io/gantree-lib-nodejs) ⭐ 12 | 🐛 35 | 🌐 JavaScript | 📅 2023-01-06 - A suite of technologies for managing Substrate-powered parachain networks via rapid spin-up & tear-down.
* [`substrate-graph-benchmarks`](https://github.com/shawntabrizi/substrate-graph-benchmarks) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2021-11-25 - Graph the benchmark output of FRAME pallets.
* [`polkadot-runtime-prom-exporter`](https://github.com/paritytech/polkadot-runtime-prom-exporter/) ⚠️ Archived - A [Prometheus](https://prometheus.io/) exporter for Polkadot runtime metrics (modifiable for Substrate use).
* [`substrate-toml-lint`](https://github.com/shawntabrizi/substrate-toml-lint) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2022-09-03 - A toml parser and checker to avoid common errors in Substrate projects.
* [`scale-decode`](https://github.com/paritytech/scale-decode) ⭐ 9 | 🐛 7 | 🌐 Rust | 📅 2025-11-21 - Decode SCALE bytes into arbitrary custom types by implementing a visitor trait.
* [`substrate-balance-calculator`](https://github.com/shawntabrizi/substrate-balance-calculator) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2022-02-09 - Breakdown the balances of your Substrate account.
* [SubID](https://github.com/dappforce/subid) ⭐ 8 | 🐛 3 | 🌐 TypeScript | 📅 2024-09-13 - An advanced cross-chain portfolio management tool for the Polkadot ecosystem, allowing any user to see their balances across chains; view their crowdloan history; view their NFTs across Polkadot ecosystem chains; claim their vested tokens and perform cross-chain transfers.
* [`polkadot-js-bundle`](https://github.com/shawntabrizi/polkadot-js-bundle) ⭐ 7 | 🐛 1 | 🌐 HTML | 📅 2022-10-25 - A standalone JS bundle that contains Polkadot{JS} libraries.
* [`substrate-balance-graph`](https://github.com/shawntabrizi/substrate-balance-graph) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2022-02-09 - Create a graph of the token balance over time of a Substrate address.
* [`substrate-society`](https://github.com/shawntabrizi/substrate-society) ⭐ 6 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-05 - A basic front-end for the FRAME Society pallet.
* [Substate](https://github.com/arrudagates/substate) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2021-10-16 - 100% no-std/wasm compatible Substrate storage key generator library for Rust.
* [Uptest Runtime upgrade tool](https://github.com/uptest-sc/uptest) ⭐ 6 | 🐛 18 | 🌐 Rust | 📅 2023-12-13 - Uptest command line client and libuptest Rust library are two tools used for debugging storage changes and runtime upgrades.
* [Minimark](https://github.com/kodadot/packages) ⭐ 4 | 🐛 59 | 🌐 TypeScript | 📅 2025-12-23 - Implementation of RMRK NFT v1/v2 protocol maintained by KodaDot.
* [Substrate Faucet Bot](https://github.com/starkleytech/substrate-faucet) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2024-06-30 - Python-based faucet for development purposes.
* [Megaclite](https://github.com/patractlabs/megaclite) ⚠️ Archived - Zero-knowledge tools for the Polkadot ecosystem.
...
* [SubQuery](https://subquery.network) - A GraphQL indexer and query service that allows users to easily create indexed data sources and host them online for free.
  * [Nova SubQuery API](https://github.com/nova-wallet/subquery-nova) ⭐ 22 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-14 - A SubQuery API implementation for operation history and staking analytics.
...
* [Gossamer](https://github.com/ChainSafe/gossamer) ⭐ 455 | 🐛 409 | 🌐 Go | 📅 2026-08-10 - A Polkadot client implemented in Go; from [ChainSafe](https://chainsafe.io/).
...
* [Parity SCALE Codec](https://github.com/paritytech/parity-scale-codec) ⭐ 286 | 🐛 69 | 🌐 Rust | 📅 2026-08-10 - Reference implementation written in Rust.
...
* [C](https://github.com/MatthewDarnell/cScale) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2022-02-16 - Maintained by Matthew Darnell.
* [C++](https://github.com/soramitsu/scale-codec-cpp) ⭐ 7 | 🐛 5 | 🌐 C++ | 📅 2025-05-15 - Maintained by Soramitsu.
...
* JavaScript / TypeScript implementations:
  * [polkadot-js/api](https://github.com/polkadot-js/api/tree/master/packages/types) ⭐ 1,108 | 🐛 43 | 🌐 TypeScript | 📅 2026-07-22 - Maintained by Polkadot-JS.
